...
| Источник                                                                                        | Что взято                                                                            |
| ----------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------ |
| [Schötz et al., 2017, VIHAR](https://vihar-2017.vihar.org/assets/papers/VIHAR-2017_paper_5.pdf) | Типы звуков: мяу, мурлыканье, трель, рычание, шипение, чириканье и типичные ситуации |
