  ...
  <div class="home">
    <div class="home-inner">
      ...
      <header class="home-hero">
        ...
        <p class="home-lede">
          Выберите животное, тип звука и что происходит рядом — сервис подберёт вероятный перевод
          по правилам из этологических статей. У кошки, собаки и курицы логика разная. Это не
      ...
      <section class="home-section">
        ...
        <div class="home-contrast block-card">
          ...
          <ul class="home-list">
            ...
            <li>
              ответ сопровождается уверенностью, альтернативами и ссылками на статьи — не
              «словарь гав = да».
            </li>
          </ul>
        </div>
